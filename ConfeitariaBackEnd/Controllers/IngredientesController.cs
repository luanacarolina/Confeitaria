...
// Criação dos controllers através da ferramenta codegenerator
//dotnet aspnet-codegenerator controller -name IngredientesController -async -api -m Ingrediente -dc ConfeitariaContext -outDir Controllers

namespace ConfeitariaBackEnd.Controllers
{
    ...
    public class IngredientesController : ControllerBase
    {
        ...
        public IngredientesController(ConfeitariaContext context)
        {
            _context = context;
        }
